...
export default function ContactForm() {
  ...
  return (
    <form className="contacts__form" id="contactsForm" action="">
        <input type="text" id="contactName" placeholder={t.contactsNamePlaceholder} className="contacts__input" required name="name"/>
        <input type="tel" id="contactPhone" placeholder={t.contactsPhonePlaceholder} className="contacts__input" required name="phone"/>
        <button type="submit" className="hero__left-link">{t.contactsSubmit}</button>
    </form>
  );
}