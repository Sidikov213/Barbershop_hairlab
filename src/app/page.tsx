...
export default function Home() {
  ...
  return (
    <>
		...
		<img src="/assets/icons/f-e-faq-mob1.svg" alt="" className="f-e-1-mob"/>
		<Header />
		...
		<section className="doing" id="doing">
			...
			<img className="f-e-2" src="assets/icons/mobvers2.svg" loading="lazy" decoding="async"/>
		</section>
		...
		<section id="work-process" className="work-process">
			<img className="f-e-3" src="assets/icons/f-e-4.svg" loading="lazy" decoding="async"/>
			<img className="f-e-3-tab" src="assets/icons/f-e-3-tab1.svg" loading="lazy" decoding="async"/>
		...
		<section id="faq" className="faq">
			<img className="f-e-faq-mob" src="assets/icons/mobvers2.svg" loading="lazy" decoding="async"/>
		...
		*/}
		...
		<img className="f-b one" src="assets/icons/mobvers2.svg" alt=""/>
		<img className="f-b two" src="assets/icons/mobvers2.svg" alt=""/>
