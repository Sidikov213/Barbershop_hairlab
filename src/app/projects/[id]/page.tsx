...
import { fetchProjectFromApi } from '@/lib/api';
        ...
        <>
                ...
                <div className="p-hero__container container">
                    ...
                    <div className="p-hero__container-bottom">
                        <div className="p-hero__container__left">
                            <img src={project.notebook_img || project.preview_img || "/assets/images/hero.png"} alt={project.title}/>
                        </div>
            ...
            <section className="p-after-about">
                <div className="p-after-about__container container">
                    <img src={project.main_img || "/assets/images/after-about.png"} alt={project.title}/>
                </div>
            </section>
                    ...
                    {project.result.images && project.result.images.length > 0 && (
                        <>
                            {project.result.images.find(img => img.type === 'tablet' || img.type === 'dashboard') && (
                                <img 
                                    className="tab" 
                                    src={project.result.images.find(img => img.type === 'tablet' || img.type === 'dashboard')?.img || "./images/tab.png"} 
                                    alt={project.title}
                                />
                            )}
                            <div className="p-gallery__container-mobs">
                                {project.result.images
                                    .filter(img => img.type === 'mobile' || img.type === 'phone')
                                    .slice(0, 3)
                                    .map((img, index) => (
                                        <img key={index} src={img.img} alt={`${project.title} - ${index + 1}`}/>
                                    ))}
                                {project.result.images.filter(img => img.type === 'mobile' || img.type === 'phone').length === 0 && (
                                    <>
